export const en = {
  ...
  'headers': {
    ...
    'confirmSaveTask': 'Do you want to save changes?',
    ...
    'goBackTo': 'Go back to',
    'haveSentEmailTo': 'we have sent an email to',
...
export const es = {
  ...
  'inputs': {
    'confirmNewPassword': 'confirmación nueva contraseña',
